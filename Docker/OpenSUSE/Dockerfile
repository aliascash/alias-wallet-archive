...
ENV ARCHIVE=Alias-${ALIAS_RELEASE}-${GIT_COMMIT}-OpenSUSE-Tumbleweed.tgz
ENV ARCHIVE_CHKSUM=Alias-${ALIAS_RELEASE}-${GIT_COMMIT}-OpenSUSE-Tumbleweed.sha256
ENV CHKSUM_FILE=Checksum-Alias-OpenSUSE-Tumbleweed.txt
