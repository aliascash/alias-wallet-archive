...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of Alias"),
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart Alias to complete"),
