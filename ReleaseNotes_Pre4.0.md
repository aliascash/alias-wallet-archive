...
- UI: [#185](https://github.com/aliascash/alias-wallet/issues/185) Fix shown staking transaction reward after wallet unlock

## 3.0.10 (released 2019-06-10)
- [#184](https://github.com/aliascash/alias-wallet/issues/184) Fix fake stake block spam attack vector
- [#173](https://github.com/aliascash/alias-wallet/issues/173) Tor process is not cleanly shutting down

## 3.0.9 (released 2019-05-05)
- UI: [#178](https://github.com/aliascash/alias-wallet/issues/178) Tooltip for SPECTRE->XSPEC balance transfer
...
- 8 hours maturity rules for staking is removed (Fixes [#79](https://github.com/aliascash/alias-wallet/issues/79))
...
- UI: [#149](https://github.com/aliascash/alias-wallet/issues/149) Fixed notifications
